class Order
  ...
  attr_accessor  :postal_code, :shipping_region_id, :city, :house_number, :house_name,:phone_number,:shipping_id, :item_id, :user_id

  validates  :postal_code, :shipping_region_id, :city, :house_number, :phone_number,  presence: true
